...
export interface ApiAnalyticAnalytic extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mediaUploaded: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    postsCreated: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    storageUsed: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    viewsTotal: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    wordsWritten: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
  };
}
...
export interface ApiCollectionCollection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    postOrder: Schema.Attribute.Component<'shared.post-order', true>;
    posts: Schema.Attribute.Relation<'manyToMany', 'api::post.post'>;
    publishedAt: Schema.Attribute.DateTime;
    shareEnabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    mood: Schema.Attribute.Enumeration<
      ['happy', 'sad', 'neutral', 'tired', 'energized', 'anxious', 'excited']
    >;
    ...
    postType: Schema.Attribute.Enumeration<
      ['quickThought', 'blog', 'image', 'video', 'audio', 'mixed', 'link']
    > &
      Schema.Attribute.DefaultTo<'blog'>;
    publishedAt: Schema.Attribute.DateTime;
    readingTime: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    shareEnabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    shareToken: Schema.Attribute.String & Schema.Attribute.Unique;
    shareViewCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    slug: Schema.Attribute.UID<'title'>;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    color: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#B82F6'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
